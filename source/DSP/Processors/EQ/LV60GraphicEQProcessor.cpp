...
namespace viator
{
    ...
    juce::AudioProcessorValueTreeState::ParameterLayout LV60GraphicEQProcessor::createParameterLayout(const int id)
    {
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID{LV60GraphicEQParameters::inputGainID + juce::String(id), 1},
            LV60GraphicEQParameters::inputGainName + juce::String(id),
            -30.0f,
            30.0f,
            0.0f));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID{LV60GraphicEQParameters::outputGainID + juce::String(id), 1},
            LV60GraphicEQParameters::outputGainName + juce::String(id),
            -30.0f,
            30.0f,
            0.0f));
